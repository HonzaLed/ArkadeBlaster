...
DATAS = []
OLD_DATAS = [bytearray(b'|\xc4\x00@\x15\x00-\x06P\x0e\x00\x00\x00\x00\x00\x01\x10\x80\x01\xf0'), bytearray(b'|\xd4\x00@\x16\x00,\x06P\x0e\x00\x00\x00\x00\x00\x01\x00\x00\x01\xf0'), bytearray(b'|\xe4\x00@\x15\x00,\x06Q\x0e\x00\x00\x00\x00\x00\x01\x00\x00\x01\xf0')]
...
async def uart_terminal():
    ...
    def handle_rx(_: int, data: bytearray):
        ...
        if data[0]==124:
            ...
            Yrot = struct.unpack("f", data[6:10])
